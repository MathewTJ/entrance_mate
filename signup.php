...
<br>
	...
	<div class="login-card">
      ...
      <!--       <input type="text" id="address" class="form-control input-sm chat-input" placeholder="Address" />
			...
			<input type="text" name="mark1"  placeholder="mark-physics" />
            <input type="text" name="mark2"  placeholder="mark-chemistry" />
            <input type="text" name="mark3" placeholder="mark-mathematics" />
